...
import yaml
from pseudoslam.envs.simulator import util 
from pseudoslam.envs.simulator import jsonReader 
# import pseudoslam
# import simulator.util
# import simulator.jsonReader
import time
...
class pseudoSlam():
    def __init__(self, param_file, obstacle_config=None):
        ...
        filepath = self.config['map_id_set'][5:]
        filedir = os.path.dirname(__file__)[:-26]
        # print("path",filedir,filedir+filepath)
        self.map_id_set = np.loadtxt(filedir+filepath, str)
